...
<body>
                        ...
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <div class="card-list">
                                    ...
                                    @php
                                    $lattar = substr($friend->name, 0,1);
                                    @endphp
                                    @if($lattar != $last_lettar)
                                    <div class="my-5">
                                        <small class="text-uppercase text-muted">{{$lattar}}</small>
                                    </div>
                                    @endif
                                    @php
                                    $last_lettar= $lattar;
                                                ...
                                                <div class="col-auto">
                                                    <div class="avatar avatar-online">
                                                        <span class="avatar-text">{{
                                                            strtoupper(substr($chat->participants[0]->name, 0,
                                                            1))}}</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <div class="card-list mt-8">
                                    ...
                                    <div class="card border-0">
                                        <img src="{{ asset('assets/img/demos/light.jpg') }}" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                    ...
                                    <div class="card border-0">
                                        <img src="{{ asset('assets/img/demos/dark.jpg') }}" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-0">
                                                <div class="col">
            ...
            <div class="container h-100">
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <!-- Chat: Form -->
                        <form class="chat-form rounded-pill bg-dark" method="post"
                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-sm">
                                                <img src="{{ asset('assets/img/avatars/2.jpg') }}" class="avatar-img"
                                                    alt="#">
                                            </a>
                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center gx-5">
                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-sm">
                                                <img class="avatar-img" src="{{ asset('assets/img/avatars/2.jpg') }}"
                                                    alt="#">
                                            </a>
    ...
    <script>
        ...
        var pusher = new Pusher('197c8830767f010910a9', {
            cluster: 'eu',
        ...
        channel.bind('new-message', function(data) {
            ...
            // addMessage(data.message.body, data.message.sender_id);
            addMessage(data.message.body, data.message.sender_id);
        });
    </script>
